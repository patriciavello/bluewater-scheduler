...
function Modal({
  ...
  async function submitRequest() {
    ...
    try {
      ...
      setSubmitMsg(`❌ ${e?.message || "Request failed"}`);
    } finally {
      setSubmitting(false);
    }
  }
        ...
        >
          ...
          >
            ...
            <div className="p-5 sm:p-6 text-slate-900">
              ...
              <div className="mt-4">
                <div className="text-sm font-medium">Request this boat</div>
              ...
              <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div className="text-xs text-slate-500">
                  This creates a <b>pending</b> request. An admin can confirm later.
                </div>
...
export default function App() {
  ...
  const days = useMemo(
    () => Array.from({ length: 14 }, (_, i) => addDays(scheduleStart, i)),
    [scheduleStart]
  );
  ...
  }, [boats, selectedBoatIds, reservationsByBoat, scheduleStart, durationDays]);
                      ...
                      return (
                        <div key={iso} className="p-2">
                          <div
                            ...
                            title={booked ? "Booked" : fit ? `Open (fits ${durationDays}-day window)` : "Open"}
                          >
